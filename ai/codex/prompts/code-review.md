...
- Freely propose refactorings when they materially reduce complexity, even if they are backward-incompatible; explicitly label compatibility breaks and required migration steps.
- Exclude security-focused analysis unless explicitly requested.
