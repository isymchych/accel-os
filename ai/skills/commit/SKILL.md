...
1) If this is a retry invocation:
   ...
   - Reuse that previous full commit message unchanged and continue at step 14.
...
12) Authorization check: if the current user request is `commit`, treat as authorized.
